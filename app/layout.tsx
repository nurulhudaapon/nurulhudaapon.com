...
import {  Linkedin, Twitter, Mail, Package, Youtube } from "lucide-react";
    ...
    <html lang="en">
      ...
      >
        <div className="grid grid-rows-[1fr_auto] min-h-screen bg-neutral-950 text-white font-sans">
          {children}
          <footer className="sticky sm:static bottom-0 w-full flex flex-row items-center justify-between gap-4 py-6 border-t border-neutral-800 bg-neutral-950 px-4 sm:px-8 text-sm">
...
const socialLinks = [
  { icon: <Mail />, href: "mailto:me@nurulhudaapon.com", label: "Email" },
  ...
  { icon: <Linkedin />, href: "https://linkedin.com/in/nurulhudaapon", label: "LinkedIn" },
  { icon: <Youtube />, href: "https://youtube.com/@nurulhudaapon", label: "YouTube" },
];
