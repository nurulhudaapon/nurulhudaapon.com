...
export interface ApiSnippetSnippet extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    ...
    slug: UIDAttribute<'api::snippet.snippet', 'title'> & RequiredAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
      'api::snippet.snippet',
